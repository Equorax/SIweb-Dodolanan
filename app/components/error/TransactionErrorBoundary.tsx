// components/error/TransactionErrorBoundary.tsx
'use client';
...
export default function TransactionErrorBoundary({ error, reset }: ErrorBoundaryProps) {
  useEffect(() => {
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="mt-5 bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded">
        ...
        <p className="mb-4">Maaf, terjadi kesalahan saat memuat data transaksi.</p>
        <button
          onClick={() => reset()}
