        ...
        <header className="bg-yellow-500 shadow-md">
          <div className="flex justify-between items-center p-4">
            ...
            <div className="flex items-center">
              <div className="mr-4 bg-white rounded-full h-8 w-8 flex items-center justify-center">
                    ...
                    <tr key={item.id} className="border-b border-gray-200">
                      ...
                      <td className="px-6 py-4">
                        <input
                          ...
                          value={item.quantity}
                          readOnly
                          className="w-32 py-1 px-2 bg-yellow-100 border border-yellow-200 rounded text-center"
                        />
                      </td>
